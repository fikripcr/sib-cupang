                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-lg-4 col-sm-12">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="password" id="password" name="password"  value="{{ $dataUser->password }}" class="form-control" required>
                                </div>

                                <!-- Password_confirmation -->
                                <div class="mb-3">
                                    <label for="password_confirmation" class="form-label">Password_confirmation</label>
                                    <input type="password" id="password_confirmation"  name="password_confirmation"  value="{{ $dataUser-> password_confirmation}}" class="form-control">
                                </div>
